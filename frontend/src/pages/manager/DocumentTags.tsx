  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button 
          onClick={() => navigate('/manager/documents/tags/create')} 
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-gray-500">
          ...
          <div className="mt-4">
            <Button onClick={() => navigate('/manager/documents/tags/create')} className="bg-orange-500 hover:bg-orange-600 text-white">
              Create Document Tag
            </Button>
          </div>
        </div>

  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="overflow-hidden cursor-pointer hover:shadow-md transition-all" onClick={() => navigate('/manager/documents/tags')}>
        ...
        <Card 
          ...
          onClick={() => navigate('/manager/documents/filtered/incomplete')}
        >
          <CardContent className="p-6">
            <div className="flex flex-col">
        ...
        <Card 
          className="overflow-hidden cursor-pointer hover:shadow-md transition-all"
          onClick={() => navigate('/manager/documents/filtered/complete')}
        >
          <CardContent className="p-6">
            <div className="flex flex-col">
                      ...
                      <TableCell className="text-right">
                        {status === 'Incomplete' ? (
                          <Button 
                            ...
                            onClick={() => navigate(`/manager/documents/${doc.id || '12345'}`)}
                          >
                            Continue Editing
                          </Button>
                        ) : (

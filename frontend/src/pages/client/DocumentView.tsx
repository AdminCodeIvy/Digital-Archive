...
import { ArrowLeft, Download, Share, Link, Copy, History, AlertCircle, Send, Loader2, MessageCircle } from "lucide-react";
...
import { PermissionRestrictedButton } from "@/components/plan/PlanPermissionUtils";
...
export default function DocumentView() {
  ...
  // Add a new component for the document chat with permission check
  const DocumentChatSection = () => {
    ...
    const handleChatWithDocument = async () => {
      ...
      try {
        ...
        const content: any[] = [
          `Answer the following question based on the content of the provided document: ${newUserMessage.content}`,
        ];
    ...
    return (
      <div className="w-full border rounded-lg p-4">
        <h3 className="font-medium text-lg mb-4">Chat with Document</h3>
    ...
    <div className="animate-fade-in">
      <div className="flex items-center gap-4 mb-6">
        ...
        <PermissionRestrictedButton
          permissionKey="can_view_activity_logs"
          variant="outline"
          className="gap-2"

      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          <Button
            ...
            onClick={() => {
              if (userRole === 'owner') {
                navigate(`/${userRole}/client-invoices`)
              } else {
                navigate(`/${userRole}/invoices`)
              }
            }
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            {(isOwner && !invoice.invoice_submitted) && (
              <Button
          ...
          {isOwner && invoice.invoice_submitted && !invoice.invoice_submitted_admin && (
          ...
          {(invoice.invoice_submitted && isClient) && (
            <div className="flex justify-end">
              <Button
                onClick={handleSubmitInvoice}
                disabled={submitInvoiceMutation.isPending}
